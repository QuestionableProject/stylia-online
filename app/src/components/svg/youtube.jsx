...
export const YoutubeSVG = () => {
    return (
        <svg onClick={() => {window.location.href="http://www.youtube.com"}} width="40" height="40" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M21.6 28.8V20.8L28 24.8001L21.6 28.8Z" fill="white" />
        </svg>
    )
}
