...
export const HamburgerIcon = ({style, color, open, onToggle}) => {
    return (
        <svg data-hamburger onClick={() => open?onToggle(false):onToggle(true)} className={style} viewBox="0 0 100 80" width="30" height="40">
